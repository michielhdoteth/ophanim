...
from visionclaw.cli.app import app
from visionclaw.models import ObserveResult, ImageResult, TimelineEntry
...
class TestBuildSummary:
    ...
    def _import_helpers(self):
        from visionclaw.cli.commands.observe import (
    ...
    def test_timeline_summary_single(self):
        ...
        from visionclaw.models import TimelineEntry
