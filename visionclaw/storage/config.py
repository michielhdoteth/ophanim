"""Configuration loader for VisionClaw."""
import os
import yaml
...
def find_config() -> Path:
    ...
    raise FileNotFoundError(
        "Cannot find config file. Set VISIONCLAW_CONFIG env var "
