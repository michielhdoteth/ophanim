"""visionclaw ask <path> <question> - Ask a specific question about a video."""
import typer
import json
...
from visionclaw.core.sampling import smart_sample, find_keyframes_for_question
...
from visionclaw.models import AskResult
