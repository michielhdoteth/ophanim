"""visionclaw observe <path> - Observe video or image."""
import typer
import json
import os
...
from visionclaw.core.video import probe, extract_frames, estimate_processing_cost
from visionclaw.core.image import downscale, encode_base64, save_frame, load_image
from visionclaw.core.sampling import smart_sample
from visionclaw.core.gpu import auto_downgrade_mode, log_vram
from visionclaw.providers.lmstudio import LmStudioProvider
from visionclaw.storage.cache import RunCache
from visionclaw.storage.config import load_config, get_mode_config
from visionclaw.models import (
