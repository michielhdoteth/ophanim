"""openvision segment <path> <prompt> - Segment objects in video."""
import typer
import json
...
from openvision.core.video import probe, extract_frames, extract_frames_by_indices
...
from openvision.models import SegmentResult, SegmentObject
